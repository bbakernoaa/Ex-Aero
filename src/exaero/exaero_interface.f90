module exaero_interface
  ...
  ! Opaque pointer representing the EX-aero package instance
  ...
  interface
    ...
    subroutine exaero_initialize_package(pkg, config_yaml) bind(c, name="exaero_initialize_package")
      import :: exaero_package_t, c_char
      type(exaero_package_t), value :: pkg
    ...
    subroutine exaero_compute_diagnostics(pkg, num_cells, num_levels, num_species, &
        temp_ptr, pres_ptr, dens_ptr, rh_ptr, thick_ptr, state_ptr, diags_ptr) bind(c, name="exaero_compute_diagnostics")
      import :: exaero_package_t, c_int, c_double
      type(exaero_package_t), value :: pkg
    ...
    subroutine exaero_compute_optics(pkg, num_cells, num_levels, num_bands, num_species, &
        wavelengths_ptr, temp_ptr, pres_ptr, dens_ptr, rh_ptr, thick_ptr, state_ptr, optics_ptr) bind(c, name="exaero_compute_optics")
      import :: exaero_package_t, c_int, c_double
      type(exaero_package_t), value :: pkg
    ...
    subroutine exaero_compute_ccn(pkg, num_cells, num_levels, num_ss, num_species, &
        ss_ptr, temp_ptr, rh_ptr, state_ptr, ccn_ptr) bind(c, name="exaero_compute_ccn")
      import :: exaero_package_t, c_int, c_double
      type(exaero_package_t), value :: pkg
    ...
    ! Dynamic Species-to-Index mapping query binders (Hole 4)
