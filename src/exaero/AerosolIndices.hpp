...
namespace exaero {
    ...
    namespace diagnostic_indices {
        ...
        constexpr int SURFACE_PM2_5_MASS = 9;       // Surface layer PM2.5 mass concentration [kg/m³]
        constexpr int COLUMN_PM2_5_MASS = 10;       // Column-integrated PM2.5 mass density [kg/m²]
    ...
    namespace optical_indices {
        ...
        constexpr int EXTINCTION_AOT = 5;           // Total Extinction Aerosol Optical Thickness (AOT)
        constexpr int SCATTERING_AOT = 6;           // Total Scattering Aerosol Optical Thickness (AOT)
        constexpr int FINE_MODE_EXTINCTION_AOT = 7;  // Fine mode (sub-micron) extinction AOT
        constexpr int FINE_MODE_SCATTERING_AOT = 8;  // Fine mode (sub-micron) scattering AOT
